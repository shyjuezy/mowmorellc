...
const testimonials = [
  {
    quote: "The mobile repair service was a game-changer for me. They fixed my riding mower right in my driveway, and I was back to mowing the same day!",
  ...
  {
    quote: "Excellent customer service and fair pricing. The technician was knowledgeable and took time to explain what was wrong with my mower and how to prevent future issues.",
  ...
  {
    quote: "I purchased a new zero-turn mower, and the guidance I received was invaluable. They helped me choose the perfect model for my large property. Couldn't be happier!",
  ...
  {
    quote: "Fast, professional service with transparent pricing. They got my commercial mowers back in service quickly, which saved me money by minimizing downtime.",
    author: "James Wilson",
    title: "Landscaping Business",
    avatar: "https://images.pexels.com/photos/697509/pexels-photo-697509.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750",
    rating: 4
  }
];
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`h-2 w-2 rounded-full transition-colors ${
                  index === activeIndex ? "bg-[#2C5F2D]" : "bg-gray-300"
                }`}
