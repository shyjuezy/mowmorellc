        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Professional lawn mower services for both residential and
              commercial clients. Choose from our mobile repair, in-shop
              service, or browse our selection of new mowers.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Our fully equipped mobile workshop brings professional lawn
                mower repair directly to your doorstep. Save time and avoid the
                hassle of transporting your equipment.
              </p>
              ...
              <Button asChild className="hover:bg-primary-hover">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Our fully equipped shop offers comprehensive repair services for
                all lawn mower makes and models. From simple tune-ups to complex
                engine rebuilds, we have the tools and expertise to get the job
                done right.
              </p>
              ...
              <div className="p-4 bg-white rounded-lg mb-8">
                ...
                <p>
                  All repair work comes with a 90-day warranty on parts and
                  labor. If the same issue recurs within the warranty period,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Shop our selection of premium lawn mowers from top brands. Our
              experts will help you find the perfect match for your lawn care
              needs and budget.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Ideal for smaller lawns. Available in manual, electric, and gas-powered models.",
                price: "Starting at $299",
                features: [
                  "Lightweight and easy to maneuver",
                  "Multiple cutting heights",
                  "Available with or without bag",
                ],
              },
              {
                ...
                image:
                  "https://images.pexels.com/photos/1301856/pexels-photo-1301856.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750",
                description:
                  "Perfect for medium-sized lawns. Reduces effort while providing excellent cutting quality.",
              ...
              },
              {
                title: "Riding Mowers",
                image:
                  "https://images.pexels.com/photos/2826131/pexels-photo-2826131.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750",
                description:
                  "For larger properties. Save time and energy with these powerful machines.",
                price: "Starting at $1,299",
                features: [
                  "Comfortable seating",
                  "Precise cutting control",
                  "Multiple deck sizes available",
                ],
              },
            ].map((mower, index) => (
              <div
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-primary font-bold mb-4">{mower.price}</p>
          ...
          <div className="mt-16 text-center">
            <p className="mb-4 text-gray-600">
              Looking for a specific model or brand? Contact us to check
              availability.
            </p>
            <Button asChild className="hover:bg-primary-hover">
      ...
      <div className="py-16 md:py-24 bg-[#F5F5F5]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Keep your equipment running at peak performance with our scheduled
              maintenance packages. Regular maintenance extends the life of your
              lawn mower and prevents costly repairs.
            </p>
          </div>
