              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-xl mb-1">contact@mowmorellc.com</p>
                    <p className="text-gray-600 text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      Visit our shop for in-person service
                    </p>
                  </div>
                </div>
              ...
              <div className="h-64 bg-[#F5F5F5] rounded-lg relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="font-medium">MowMore LLC Shop Location</p>
                    <p className="text-sm text-gray-600">
                      123 Green Street, Lawn City
                    </p>
                  </div>
                </div>
              </div>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent>
                                <SelectItem value="mobile-repair">
                                  Mobile Repair
                                </SelectItem>
                                <SelectItem value="shop-repair">
                                  In-Shop Repair
                                </SelectItem>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-sm font-medium text-[#2C5F2D] mb-4">
                  Service Days: {area.days}
                </p>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 mb-4">
              Don&apos;t see your area? Contact us to check if we can
              ...
              {[
                {
                  ...
                  answer:
                    "Our mobile repair service brings our fully-equipped workshop directly to your location. We'll diagnose and repair your lawn mower on-site, saving you the hassle of transporting your equipment. We carry common parts and can order specialized parts if needed.",
                },
                {
                  question: "What brands do you service?",
                  answer:
                    "We service all major lawn mower brands, including Honda, Toro, John Deere, Craftsman, Husqvarna, Cub Cadet, and many more. Our technicians are certified and experienced with a wide range of equipment.",
                },
                {
                  question: "Do you offer warranty on repairs?",
                  answer:
                    "Yes, all our repairs come with a 90-day warranty on parts and labor. If the same issue recurs within this period, we'll fix it at no additional cost.",
                },
                {
                  question: "How do I schedule a service?",
                  answer:
                    "You can schedule a service by calling us at (555) 123-4567, filling out our contact form, or visiting our shop in person. We'll work with you to find a convenient time for your repair.",
                },
                {
                  question: "Do you sell new lawn mowers?",
                  answer:
                    "Yes, we offer a selection of high-quality new lawn mowers from top brands. Visit our shop to see current inventory or contact us for specific models.",
                },
              ].map((faq, index) => (
