    ...
    <div className="relative overflow-hidden bg-white">
      <div className="absolute inset-0 z-0">
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.pexels.com/photos/589/garden-gardening-grass-mow.jpg?auto=compress&cs=tinysrgb&w=1260&h=750')",
        ...
        <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          <div className="bg-black/50 p-6 rounded-lg backdrop-blur-xs">
            ...
            <p className="mt-6 text-lg leading-7 text-white">
              Expert mobile and in-shop repair services for all makes and models.
              We bring professional repair to your doorstep, or visit our full-service shop.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <Button asChild size="lg" variant="outline" className="bg-white text-[#2C5F2D] border-[#2C5F2D] hover:bg-[#F5F5F5]">
                <Link href="/services">
